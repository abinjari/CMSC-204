...
public class MyQueueTest {
	...
	public void testDequeueStudent() {
	    doubleQ = new MyQueue<>(3); // Initialize a queue with capacity 3
	    doubleQ.enqueue(1.1);
	    doubleQ.enqueue(2.2);
	    doubleQ.enqueue(3.3);
	    ...
	    try {
	        ...
	        // Queue is now empty, the next dequeue should throw an exception
	        doubleQ.dequeue();
	...
	public void testEnqueueStudent() {
	    doubleQ = new MyQueue<>(3); // Small queue for testing overflow
	    try {
	        assertEquals(true, doubleQ.enqueue(4.4));
	        assertEquals(true, doubleQ.enqueue(5.5));
	        assertEquals(true, doubleQ.enqueue(6.6));
	        // Queue is now full, next enqueue should throw an exception
	        doubleQ.enqueue(7.7);
