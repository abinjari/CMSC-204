...
public class MyStackTest {
	...
	public void testPopStudent() {
	    doubleS = new MyStack<>(5); // Initialize student stack
	    doubleS.push(1.1);
	    doubleS.push(2.2);
	    doubleS.push(3.3);
	    ...
	    try {
	        ...
	        // Stack is now empty, the next pop should throw an exception
	        doubleS.pop();
	...
	public void testPushStudent() {
	    doubleS = new MyStack<>(3); // Small stack for testing overflow
	    try {
	        assertEquals(true, doubleS.push(4.4));
	        assertEquals(true, doubleS.push(5.5));
	        assertEquals(true, doubleS.push(6.6));
	        // Stack is now full, next push should throw an exception
	        doubleS.push(7.7);
